...
import wordpress from "../../../Assets/icons/footer/word.png";
import google from "../../../Assets/icons/footer/google.png";
import tweet from "../../../Assets/icons/footer/tweet.png";
import heart from "../../../Assets/icons/footer/heart.png";
const footer = () => {
  return (
        ...
        <Row>
          <Col>
            <p className="footer-text">
              ...
              &copy; COPYRIGHT 2018 reserved by 2 Brother Pizza and Burger
              <br />
              <br />
              Made with{" "}
              <img
              ...
              >
                Aashish Peepra aka Iron Programmer (Love Aashiya)
              </a>
            </p>
          </Col>
        </Row>
